...
decrementCartCount(id:any){
  ...
  // login
  login(fname:any,password:any){
    const body={
      fname,
      password
    }
    return this.http.post('http://localhost:5000/products/login',body)
  }

//register

register(fname: any, password: any, email: any, mobile: any) {
  ...
  return this.http.post('http://localhost:5000/products/login/register', body)
}
